...
const TeacherForm = ({ type, data }: {
    ...
    return (
        <form className="flex flex-col gap-4 max-h-[calc(100vh-5rem)] overflow-auto" onSubmit={onSubmit}>
            <h1 className="text-lg font-semibold">{ `${ type === 'create'? 'Create a new teacher' : 'Update teacher' }` }</h1>
                ...
                <div className="flex flex-wrap gap-y-4 items-start justify-between">
                    <div className="flex flex-col gap-2 w-full md:w-[calc(33.33%-1rem)]">
                        <div className="flex flex-col gap-1">
                            <label className="text-xs text-gray-500">Teacher&apos;s Photo</label>
                    ...
                    <div className="flex flex-col gap-2 w-full md:w-[calc(33.33%-1rem)]">
                        <div className="flex flex-col gap-1">
                            ...
                            <select className="border border-slate-300 p-2 rounded-md text-sm w-full h-10">
